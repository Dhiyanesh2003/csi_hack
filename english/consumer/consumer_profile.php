...
<body>
	<header>
		<div class="contt">
			...
			<a class="aa current" href="consumer_profile.php">
				<div class="item">
					<h4>Profile</h4>
				</div>
			</a>
	...
	<main>
		...
		<form class="Button_cont" action="save.php" method="POST">
			...
			<center>
				<input id="edit_button" class="btn" type="submit" onclick="get_input()" value="Edit" />
			</center>

			<center>
				<input id="save_button" style="display: none" class="btn" type="submit" onclick="save_input()" value="Save" />
			</center>
		</form>
		<br />
		<hr />
